...
-- Drop existing triggers and functions properly
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users CASCADE;
DROP TRIGGER IF EXISTS after_user_signup ON auth.users CASCADE;
...
-- Create trigger that fires after user is confirmed (for email verification)
...
-- Create RLS policies that work properly with SECURITY DEFINER function
