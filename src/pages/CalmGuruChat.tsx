...
import { Send, ArrowLeft, Flower2 } from "lucide-react";
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-700 bg-gray-800/50 backdrop-blur-sm">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-semibold">Calm Guru</h1>
          </div>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-300 text-lg">
                Welcome, dear friend. I am here to guide you toward inner peace. How may I help you today?
              </p>
            </div>
          ) : (
            ...
            <div className="flex justify-start">
              <Card className="max-w-xs sm:max-w-md p-4 bg-gray-700 text-gray-100">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-400">Finding inner wisdom...</span>
                </div>
              </Card>
            </div>
          )}
      ...
      <div className="p-4 border-t border-gray-700 bg-gray-800/50 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto flex items-center space-x-2">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-green-400 to-green-600 hover:opacity-80 text-white"
          >
